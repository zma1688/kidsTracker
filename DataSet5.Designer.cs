...
namespace Project {
    ...
    public partial class DataSet5 : global::System.Data.DataSet {
        ...
        public partial class SchoolDataTable : global::System.Data.TypedTableBase<SchoolRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SchoolRow AddSchoolRow(string Name, string StreetAddress, string City, string State, string Zip, string ContactNumber) {
...
namespace Project.DataSet5TableAdapters {
    ...
    public partial class SchoolTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [School] WHERE (([Name] = @Original_Name) AND ([StreetAddress] = @Original_StreetAddress) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([Zip] = @Original_Zip) AND ((@IsNull_ContactNumber = 1 AND [ContactNumber] IS NULL) OR ([ContactNumber] = @Original_ContactNumber)) AND ([SchID] = @Original_SchID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [School] SET [Name] = @Name, [StreetAddress] = @StreetAddress, [City] = @City, [State] = @State, [Zip] = @Zip, [ContactNumber] = @ContactNumber WHERE (([Name] = @Original_Name) AND ([StreetAddress] = @Original_StreetAddress) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([Zip] = @Original_Zip) AND ((@IsNull_ContactNumber = 1 AND [ContactNumber] IS NULL) OR ([ContactNumber] = @Original_ContactNumber)) AND ([SchID] = @Original_SchID));
SELECT Name, StreetAddress, City, State, Zip, ContactNumber, SchID FROM School WHERE (SchID = @SchID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Name, StreetAddress, City, State, Zip, ContactNumber, SchID FROM School WH" +
                "ERE (SchID = @SchID)";
        ...
        public virtual int Fill(DataSet5.SchoolDataTable dataTable, int SchID) {
        ...
        public virtual DataSet5.SchoolDataTable GetData(int SchID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(SchID));
            DataSet5.SchoolDataTable dataTable = new DataSet5.SchoolDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet5.SchoolDataTable dataTable) {

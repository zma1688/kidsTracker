...
namespace Project {
    ...
    public partial class DataSet4 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(int SchID, string LastName, string FirstName, string DateOfBirth, string EmergencyContactNumber) {
...
namespace Project.DataSet4TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Student] WHERE (([SID] = @Original_SID) AND ([SchID] = @Original_SchID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([EmergencyContactNumber] = @Original_EmergencyContactNumber))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Student] ([SchID], [LastName], [FirstName], [DateOfBirth], [EmergencyContactNumber]) VALUES (@SchID, @LastName, @FirstName, @DateOfBirth, @EmergencyContactNumber);
...
SELECT SID, SchID, LastName, FirstName, DateOfBirth, EmergencyContactNumber FROM Student WHERE (SID = @SID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SID, SchID, LastName, FirstName, DateOfBirth, EmergencyContactNumber\r\nFROM" +
                "     Student\r\nWHERE  (SchID = @SchID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@SchID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "SchID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet4.StudentDataTable dataTable, int SchID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(SchID));
        ...
        public virtual DataSet4.StudentDataTable GetData(int SchID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(SchID));
            DataSet4.StudentDataTable dataTable = new DataSet4.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet4.StudentDataTable dataTable) {
